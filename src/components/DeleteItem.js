...
import {
  StyleSheet, View, ListView, ScrollView, Image,
  TouchableOpacity, FlatList, Alert
} from "react-native";
import {
  Container, Header, Title, Content, Footer,
  FooterTab, Button, Left, Right, Body,
  Icon, Text, List, ListItem, Form, Picker, SwipeRow, Root, Toast
} from 'native-base';
  ...
  renderRow(data) {
    return (
      <SwipeRow
        ...
        right={
          <Button danger onPress={() => this.deleteItemXL({ data })} style={{ flexDirection: 'column' }}>
